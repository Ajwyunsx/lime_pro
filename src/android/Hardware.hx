...
class Hardware {
	...
	{
		var vibrate_jni = JNICache.createStaticMethod("org/haxe/extension/Hardware", "vibrate", "(I)V");
	...
	{
		var wakeUp_jni = JNICache.createStaticMethod("org/haxe/extension/Hardware", "wakeUp", "()V");
		wakeUp_jni();
	}
	...
	{
		var setbrightness_set_brightness_jni = JNICache.createStaticMethod("org/haxe/extension/Hardware", "setBrightness", "(F)V");
	...
	{
		var setRequestedOrientationNative = JNICache.createStaticMethod("org/haxe/extension/Hardware","setRequestedOrientation","(I)V");
	...
	{
		var get_screen_width_jni = JNICache.createStaticMethod("org/haxe/extension/Hardware", "getScreenWidth", "()I");
	...
	{
		var get_screen_height_jni = JNICache.createStaticMethod("org/haxe/extension/Hardware", "getScreenHeight", "()I");
